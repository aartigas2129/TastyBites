    ...
    <div class="homer mt-5 pt-5">
      <div class="homer-item-1">
        <div class="homer-inside-item-1">
          ...
          <p class="homer-para">Upload and share your recipes with TastyBites community.</p>
        </div>
          ...
          <div class="col-md-4">
            <div class="card recipe-card h-100">
              ...
              <div class="card-body">
                ...
                <small><b>Ingredients:</b><br><?php echo nl2br(htmlspecialchars($row['ingredients'])); ?></small><br>
                <small><b>Instructions:</b><br><?php echo nl2br(htmlspecialchars($row['instructions'])); ?></small>
              </div>
            </div>
          </div>
        <?php } ?>
